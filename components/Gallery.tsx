      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3 border border-[#513550] text-[#513550] hover:bg-[#513550] hover:text-white text-xs tracking-[0.25em] uppercase transition-all duration-300"
            style={{ fontFamily: "'Lato', sans-serif" }}
          >
