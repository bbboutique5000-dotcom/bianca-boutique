...
export default function Gallery() {
  ...
  return (
    <section id="galeria" className="py-24 bg-bb-ivory">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {photos.map((photo, i) => (
            <button
              ...
              className={`group relative overflow-hidden bg-bb-rose-light cursor-pointer ${
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-bb-noir/0 group-hover:bg-bb-noir/40 transition-colors duration-300 flex items-center justify-center">
                <svg
        ...
        <div className="text-center mt-12">
          <p
            className="text-bb-rose-dark text-sm tracking-wide mb-4"
            style={{ fontFamily: 'var(--bb-font-body)' }}
          >
          ...
          <a
            ...
            className="bb-btn-secondary inline-flex items-center gap-2"
          >
