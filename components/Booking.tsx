...
const servicios = [
  {
    ...
    options: [
      'Diseño de cejas — 13 € · 10-15 min',
      'Depilación de labios — 7 € · 5 min',
      'Depilación contorno de labios — 1 € · 2 min',
      'Depilación de barbilla — 7 € · 5-7 min',
      'Depilación de patillas — 10 € · 8-10 min',
      'Depilación de mejillas — 7 € · 8-10 min',
      'Depilación de nariz — 3 € · 4-6 min',
      'Depilación de entrecejos — 3 € · 2 min',
      'Depilación de sienes — 6 € · 4-6 min',
      'Depilación de frente — 10 € · 5-7 min',
      'Depilación de cuello — 12 € · 8-10 min',
      'Depilación de orejas — 8 € · 7-9 min',
      'Depilación de dedos — 8 € · 4-6 min',
      'Depilación cara completa — 33 € · 30 min',
    ],
  },
  {
    group: 'Lifting de Pestañas',
    options: [
      'Lifting tradicional — 40 € · 45-60 min',
      'Lifting fusión — 75 € · 75-80 min',
      'Lifting coreano — 90 € · 90 min',
    ],
  },
  {
    group: 'Laminado de Cejas',
    options: [
      'Laminado tradicional — 45 € · 20-25 min',
      'Laminado coreano — 50 € · 30-35 min',
    ],
  },
  {
    group: 'Henna',
    options: [
      'Henna — 20 € · 20-25 min',
      'Henna + diseño de cejas — 30 € · 30-35 min',
    ],
  },
  {
    group: 'Tinte',
    options: [
      'Tinte de cejas — 12 € · 8-10 min',
      'Tinte de pestañas — 12 € · 8-10 min',
    ],
  },
  {
    group: 'Tratamientos Faciales',
    options: [
      'Limpieza facial — 50 € · 60 min',
      'Microshading — 250 € · 120 min',
      'Glossyps — 250 € · 90 min',
      'Hidrolips — 80 € · 30 min',
    ],
  },
